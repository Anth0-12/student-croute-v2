...
<div class="main_boisson">
    ...
    <div id="myBtnContainer">
      ...
      <div class="categ_boutons">
        <button class="btn active" onclick="filterSelection('all')"> Voir toutes les boissons</button>
        <button class="btn" onclick="filterSelection('froides')"> Boissons froides</button>
        <button class="btn" onclick="filterSelection('chaudes')"> boissons chaudes</button>
      </div>
...
<img src="assets/img/astronaute.png" alt="" id="astronaute_boisson">

<img src="assets/img/fusee.png" alt="" id="fusee_boisson">
